...
export class CategoryComponent implements OnInit {
  ...
  ngOnInit(): void { 
    ...
    this.ctgysrv.fetchFiltesr().subscribe((data:any) => {
      ...
      this.rangeValue = [parseInt(data?.price?.min), parseInt(data?.price?.max)];
    });
  ...
  clearFilter(id:number){
    ...
    this.ctgysrv.filterWiseProduct(id,'','','','','yes').subscribe((data:any) => {
      this.categoryWiseProduct =  data
      this.productPageLoading = false
    })
    this.selectedTab = id
   ...
   this.rangeValue = [parseInt(this.filters?.price?.min), parseInt(this.filters?.price?.max)];
  }
  ...
  applyFilter(id:any){
    ...
    this.ctgysrv.filterWiseProduct(id || this.selectedTab,this.metalVal,this.styleSelectedVal,this.setPriceValue[0],this.setPriceValue[1],'no').subscribe((data:any) => {
      this.categoryWiseProduct =  data
      this.productPageLoading = false
    })
  }
