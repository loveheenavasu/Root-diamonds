...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ctgysrv.filterWiseProduct(0,'','','','','no').subscribe((data:any) => {
   ...
   let productItem :any = localStorage.getItem("product-item")
    ...
    if(localStorage.getItem('scroll') === '1'){
      setTimeout(() => { 
        let element:HTMLElement = document.querySelector("#bottom-btn") as HTMLElement; 
        element.click();
      }, 200);
  ...
  initScrollTriggers() {
    ...
    installMediaQueryWatcher('(min-width: 768px)', function (matches: any) { 
      if (matches) {
        ...
        animateWrapper
          .from('.main-banner', {zIndex: 1,duration: 0.01,}).to('.main-banner', {zIndex: 1, duration: 0.01,}) 
          .from('.rd-mb-5', {opacity: 0,duration: 1,}).to('.fade-top', {opacity: 0,y: '-50vh',duration: 1.3,zIndex: 1,}) 
          .to('.main-banner', {zIndex: -1,}).to('.curate-deep', {zIndex: 1,duration: 0.01,})
          .from('.curate-deep-text', {opacity: 0,y: '50vh',duration: 1.3})
          .to('.curate-deep-text', {opacity: 1,y: '0',duration: 0.1,})          
          .from('.curate-deep-img figure', {height: 0,duration: 1,}).to('.curate-deep-img figure', {height: '434px',duration: 1,})
          .from('.img-text h2', {height: '0%',duration:0.1,}).to('.img-text h2', {height:'100%',duration: 1,})
          .to('.curate-deep-text', {opacity: 0,y: '0',duration: 0.001,}).to('.img-text', {opacity: 1,duration: 0.1,})
          .to('.curate-deep-text,.curate-deep-img figure,.img-text', {opacity: 0,y: '-50vh',duration: 1.5,})
          .to('.curate-deep', {zIndex: 1,duration: 0.01,}).to('.curate-deep', {zIndex: -1,duration: 0.01,}) 
          .to('.origin-value', {zIndex: 1,duration: 0.01,}).from('.origin-value-img', {opacity: 0,duration: 0.5,delay: 0.2,})
          .to('.origin-value-img', {opacity: 1,duration: 0.5,ease: 'none',}).from('.origin-value .overlay-text', {opacity: 0,duration: 2,y: '50vh',})
          .to('.origin-value .overlay-text', {opacity: 1,y: '0',duration: 1,}).to('.origin-value .overlay-text', {opacity: 0,y: '-50vh',duration: 2,})
          .to('.origin-value-img', {opacity: 0,duration: 0.5,}).to('.origin-value', {zIndex: 1,duration: 0.01,})
          .to('.origin-value', {zIndex: -1,duration: 0.01,}).to('.origin-value-text', {zIndex: 1,duration: 0.01,}) 
          .from('.origin-value-text [data-value="2"]', {opacity: 0,duration: 1,}).from('.origin-value-text [data-value="3"]', {opacity: 0,duration: 1,})
          .from('.origin-value-text [data-value="4"]', {opacity: 0,duration: 1,}).to('.origin-value-text', {opacity: 0,duration: 1,})
          .to('.origin-value-text', {zIndex: 1,duration: 0.01,}).to('.origin-value-text', {zIndex: -1,duration: 0.01,})
         .to('.real-value', {zIndex: 1,duration: 0.01,}).from('.real-value [data-value="1"]', {
            opacity: 0,duration: 2,y: '50vh',}).to('.real-value [data-value="1"]', {
            opacity: 1,y: '0',duration: 1,}).to('.real-value [data-value="1"]', {opacity: 0,y: '-50vh',duration: 2,ease: 'none',})
          .to('.real-value', {zIndex: 1,duration: 0.01,}).to('.real-value', {zIndex: -1,duration: 0.01,})
          
          .to('.their-stories', {zIndex: 1,duration: 0.01,}).from('ngx-slick-carousel,.their-stories .csheading', {
            opacity: 0,duration: 1,delay: 0.2,})
          .to('.their-stories', {opacity: 1,duration: 1,zIndex: 9, }).to('.their-stories', {opacity: 0,duration: 1,zIndex: 9,}).to('.their-stories', {zIndex: 1,duration: 0.01,}).to('.their-stories', {zIndex: -1,duration: 0.01,})
            .to('.diamond-always', {zIndex: 1,duration: 0.01,}).from('.diamond-always [data-value="1"]', {opacity: 0,duration: 2,y: '50vh',delay: 0.2,
          }).to('.diamond-always [data-value="1"]', {opacity: 1,y: '0',duration: 1,}).to('.diamond-always [data-value="1"]', {opacity: 0,y: '-50vh',duration: 2,ease: 'none',}).to('.diamond-always', {zIndex: 1,duration: 0.01,}).to('.diamond-always', {zIndex: -1,duration: 0.01,})
          .to('.text-sec-cs', {zIndex: 1,duration: 0.01,}).from('.text-sec-cs  [data-value="1"]', {opacity: 0,duration: 2,y: '50vh',delay: 0.2,}).to('.text-sec-cs  [data-value="1"]', {opacity: 1,y: '0',duration: 1,}).to('.text-sec-cs  [data-value="1"]', {
            opacity: 0,y: '-50vh',duration: 2,}).to('.text-sec-cs', {zIndex: 1,duration: 0.01,}).to('.text-sec-cs', {zIndex: -1,duration: 0.01,})
            .to('.diamond-jewelry', {zIndex: 1,duration: 0.01,}).from('.diamond-jewelry', {opacity: 0,duration: 1,delay: 0.2,}).to('.diamond-jewelry [data-value="1"]', {opacity: 1,duration: 2,}).from('.diamond-jewelry [data-value="2"]', {opacity: 0,duration: 0.5,}).to('.diamond-jewelry [data-value="2"]', {opacity: 1,duration: 0.5,}).to('.diamond-jewelry [data-value="2"]', {opacity: 0,duration: 0.5,}).to('.diamond-jewelry [data-value="1"]', {opacity: 0,duration: 1.5,}).to('.diamond-jewelry', {zIndex: 1,duration: 0.01,}).to('.diamond-jewelry', {
            zIndex: -1,duration: 0.01,});
        ...
        const animateWrapper1 = gsap.timeline({
          ...
          onToggle: self => {
            if(self.isActive){
              const shopRemove: any =  document.querySelector('.bottom-shop-btn');
    ...
    installMediaQueryWatcher('(max-width: 767px)', function (matches: any) {
      if (matches) { 
        ...
        animateWrapper
          ...
          .to('.main-banner', {opacity: 0,y: '-50%',duration: 1.3, ease: "linear", })
          ...
          .from('.curate-deep-text', {opacity: 0,y: '50vh',duration: 1.3,ease: "linear",})
          .to('.curate-deep-text', {opacity: 1,y: '0',duration: 0.1,})         
          .from('.curate-deep-img figure', {height: 0,duration: 0.2,ease: "linear",})
          .to('.curate-deep-img figure', {height: '90px',duration: 0.3,ease: "linear",})
          
          .to('.curate-deep-img figure', {height: '434px',duration: 2,ease: "linear",})
          ...
          .to('.curate-deep', {opacity: 0,y: '-50vh',duration: 1.3,ease: "linear", })
          ...
          .from('.origin-value .overlay-text', {opacity: 0,duration: 2,y: '50vh',ease: "linear", })
          .to('.origin-value .overlay-text', {opacity: 1,y: '0',duration: 0.001,ease: "linear",})
          .to('.origin-value .overlay-text', {opacity: 0,y: '-50vh',duration: 2,ease: "linear",})
          ...
          // 4
          .from('.origin-value-text', {zIndex: -1,duration: 0.001,opacity:0})
          .to('.origin-value-text', {zIndex: 1,duration: 0.001,opacity:1})
          .from('.origin-value-text [data-value="2"]', {opacity: 0,duration: 0.7,ease: "linear",})
          .to('.origin-value-text [data-value="2"]', {opacity: 1,duration: 0.7,ease: "linear",})
          .to('.origin-value-text [data-value="2"]', {opacity: 0,duration: 0.7,ease: "linear",})
          .from('.origin-value-text [data-value="3"]', {opacity: 0,duration: 0.7,ease: "linear",})
          .to('.origin-value-text [data-value="3"]', {opacity: 1,duration: 0.7,ease: "linear",})
          .to('.origin-value-text [data-value="3"]', {opacity:0,duration: 0.7,ease: "linear",})
          .from('.origin-value-text [data-value="4"]', {opacity: 0,duration: 0.7,ease: "linear",})
          .to('.origin-value-text [data-value="4"]', {opacity: 1,duration: 0.7,ease: "linear",})
          .to('.origin-value-text [data-value="4"]', {opacity:0,duration: 0.7,ease: "linear",})
          ...
          .from('.real-value [data-value="1"]', {opacity: 0,duration:2,y: '50vh',ease: "linear", })
          .to('.real-value [data-value="1"]', {opacity: 1,y: '0',duration: 0.001,ease: "linear",})
          .to('.real-value [data-value="1"]', {opacity: 0,y: '-50vh',duration: 2,ease: "linear",})
          // .to('.real-value', {
          //   zIndex: 1,
          //   duration: 0.01,
          //   opacity:1,
          ...
          // 7
          .from('.their-stories', {zIndex: -1,display:"none", duration: 0.01,opacity:0,ease: "linear",})
          .to('.their-stories', {zIndex: 1,display:"flex",opacity:1,duration: 0.01,ease: "linear",})
          .from('.their-stories >*', {opacity: 0,duration: 0.8,ease: "linear",})
          .to('.their-stories >*', {opacity: 1,duration: 0.8,ease: "linear", })
          .to('.their-stories > *', {opacity: 0,duration: 0.8, ease: "linear",})
          // .to('.their-stories', {
          //   zIndex: 1,
          //   duration: 1,
          //   opacity:0,
          //   ease: "linear", 
          // })
          .to('.their-stories', {zIndex: -1,display:"none",opacity:0,duration: 0.01,ease: "linear",})
          // 8
          .from('.diamond-always', {zIndex: -1,duration: 0.01,opacity:0}).to('.diamond-always', {zIndex: 1,duration: 0.01,opacity:1})
          .from('.diamond-always [data-value="1"]', {opacity: 0,duration: 2,y: '50vh',ease: "linear",})
          .to('.diamond-always [data-value="1"]', {opacity: 1,y: '0',duration: 0.001,ease: "linear",})
          .to('.diamond-always [data-value="1"]', {opacity: 0,y: '-50vh',duration:2,ease: "linear",})
          ...
          .from('.text-sec-cs  [data-value="1"]', {opacity: 0,duration: 2.5,y: '100vh',ease: "linear",})   
          .to('.text-sec-cs  [data-value="1"]', {y: '0vh',duration: 0.001,opacity:1,ease: "linear", })
          .to('.text-sec-cs  [data-value="1"]', {y: '-100vh',duration: 2.5,opacity:0,ease: "linear",})
          ...
          .from('.diamond-jewelry .top-text', {opacity: 0,duration: 0.7,delay: 0.2,ease: "linear",})
          .to('.diamond-jewelry .top-text', {opacity: 1,duration: 0.7,ease: "linear",})
          .to('.diamond-jewelry .top-text', {opacity: 0,duration: 0.7,ease: "linear",})
          .from('.diamond-jewelry .bottom-img', {opacity: 0,duration: 0.7, ease: "linear",})
          .to('.diamond-jewelry .bottom-img', {opacity: 1,duration: 0.7,ease: "linear",})
          .to('.diamond-jewelry .bottom-img', {opacity: 0,duration: 0.7,ease: "linear",})
          .from('.diamond-jewelry .center-img', {opacity: 0,duration: 0.7,delay: 0.2,ease: "linear",})
          .to('.diamond-jewelry .center-img', {opacity: 1,duration: 0.7,ease: "linear",})
          .to('.diamond-jewelry .center-img', {opacity: 0,duration: 0.7 ,ease: "linear",})
          .to('.diamond-jewelry', {zIndex: 1,duration: 0.01,opacity:1,})
...

{
    ...
    activeSlide(one: any){ 
      setTimeout(() => { 
        let element:HTMLElement = document.querySelector(".stories-carousel-thumbnail  [data-slick-index='"+one+"']") as HTMLElement; 
        element.click();
      }, 100);
    } 
  // Stories slider End ==================================================
  ...
  showModal(product:object): void {
    ...
    // console.log(data,'sadjasdkasdasdadadad')
    // this.videoSource = data?.product_video
    // this.productDetail = data
    // let galleryImg = this.productDetail.galleryImg
    //    return galleryImg
    // this.homesrv.getProductById(id).subscribe((data:any) => {
    //   if(data){
    //     this.loading = false
...
this.isWholeSaleVisible = true
  ...
  wholeSaleChange(bool:any, price:any){
    ...
    let wholeSalecheck =  this.isWholeSaleChecked ? this.productDetail?.wholesale_price_for_variation : this.productDetail?.whole_sale_price 
   let normal = this.isWholeSaleChecked ? this.productDetail?.sales_price_for_variation : this.productDetail?.price
    
   this.newPrice  = this.fillWholeSaleForm ? wholeSalecheck : normal

    localStorage.setItem('product-item', JSON.stringify({state:{isWholeSaleChecked:this.isWholeSaleChecked,checkIsWholeSale:this.checkIsWholeSale,product:this.productDetail, wholeSalePrice:this.newPrice || price,checkWholeSaleForm:this.checkWholeSaleForm.value, productId:bool}}))
